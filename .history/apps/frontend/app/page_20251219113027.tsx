      ...
      <div className="min-h-screen text-white p-6 bg-[radial-gradient(circle_at_top,#071029,#020617_70%)] flex items-center">
        ...
        <div className="w-full max-w-6xl mx-auto grid grid-cols-12 gap-6 items-center">
          ...
          <main className="col-span-6 flex items-center justify-center">
            <div className="w-full bg-gradient-to-b from-black/60 via-black/40 to-black/30 border border-yellow-600 rounded-3xl p-8 text-center shadow-2xl">
              <p className="text-xs uppercase text-gray-400">Now Auctioning</p>

              {currentPlayer ? (
                <>
                  <div className="mt-2 flex items-center justify-center gap-4">
                    <div className="w-20 h-20 rounded-full bg-gradient-to-br from-yellow-400 to-orange-500 flex items-center justify-center text-3xl font-bold shadow-inner">
              ...
              {me?.boughtPlayers?.length ? (
                <ul className="mt-2 text-yellow-300 space-y-1">
                  {me.boughtPlayers.map(pl => (
                    <li key={pl.id} className="px-3 py-1 rounded bg-black/40">• {pl.name} <span className="text-xs text-gray-400">({pl.role})</span></li>
                  ))}
                </ul>
              ) : (
