              ...
              {currentPlayer ? (
                <>
                  <div className="mt-6 flex items-center justify-center gap-6">
                    <div className="w-24 h-24 rounded-full bg-gradient-to-br from-amber-400 to-orange-600 flex items-center justify-center text-4xl font-bold shadow-lg shadow-amber-600/50 transform hover:scale-110 transition-transform">
                  ...
                  <div className="mt-8 space-y-3">
                    <div className="text-6xl md:text-7xl font-black text-transparent bg-clip-text bg-gradient-to-r from-amber-300 via-amber-400 to-orange-400 drop-shadow-xl">
                  ...
                  <div className="flex justify-center gap-4 mt-8">
                    <button
                      ...
                      className="px-10 py-4 rounded-xl font-bold text-lg bg-gradient-to-r from-amber-400 to-orange-500 text-slate-900 hover:from-amber-300 hover:to-orange-400 shadow-lg shadow-amber-500/50 transform hover:scale-105 transition-all disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
