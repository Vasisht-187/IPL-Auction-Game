        ...
        <div className="w-full max-w-7xl mx-auto grid grid-cols-12 gap-8 items-stretch">
          ...
          <aside className="col-span-3 space-y-4">
            ...
            {room.players.map((p, i) => (
              <div
                key={p.socketId}
                className={`p-3 rounded-xl border backdrop-blur-sm ${p.username === username ? "border-yellow-500 bg-yellow-500/6" : "border-white/6 bg-black/50"}`}
              >
                ...
                <div className="text-xs text-gray-400 mt-2">💰 ₹{Number(p.purse ?? 0).toFixed(2)}</div>
              </div>
            ))}
          </aside>
